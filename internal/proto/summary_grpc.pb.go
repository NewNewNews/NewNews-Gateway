...
const (
	SummaryService_SummarizeNews_FullMethodName = "/summaryservice.SummaryService/SummarizeNews"
)
...
type SummaryServiceClient interface {
	SummarizeNews(ctx context.Context, in *SummaryNewsRequest, opts ...grpc.CallOption) (*SummaryNewsResponse, error)
}
...
func (c *summaryServiceClient) SummarizeNews(ctx context.Context, in *SummaryNewsRequest, opts ...grpc.CallOption) (*SummaryNewsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SummaryNewsResponse)
	err := c.cc.Invoke(ctx, SummaryService_SummarizeNews_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SummaryServiceServer interface {
	SummarizeNews(context.Context, *SummaryNewsRequest) (*SummaryNewsResponse, error)
...
func (UnimplementedSummaryServiceServer) SummarizeNews(context.Context, *SummaryNewsRequest) (*SummaryNewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SummarizeNews not implemented")
}
...
func _SummaryService_SummarizeNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SummaryNewsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SummaryServiceServer).SummarizeNews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SummaryService_SummarizeNews_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SummaryServiceServer).SummarizeNews(ctx, req.(*SummaryNewsRequest))
	}
...
var SummaryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "summaryservice.SummaryService",
	HandlerType: (*SummaryServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SummarizeNews",
			Handler:    _SummaryService_SummarizeNews_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/proto/summary.proto",
}
